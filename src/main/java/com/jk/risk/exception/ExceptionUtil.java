...
import com.jk.risk.util.Constants;
import com.jk.risk.util.TimeUtil;
...
public class ExceptionUtil {
    ...
    public static String print(HttpServletRequest request, Throwable e) {
        ...
        sb.append("RequestID").append(COLON).append(request.getAttribute(Constants.REQUEST_ID)).append(NEWLINES);
